...
public class MyConditionCount3 {
	...
	public static void main(String[] args){	
		...
		Job job;
		try {
			job = Job.getInstance(config, "MyConditionCount3");
			job.setJarByClass(MyConditionCount3.class);     // class that contains mapper
			...
			ColumnPrefixFilter filter1 = new ColumnPrefixFilter(Bytes.toBytes("05f8b534e090480899355a4b0b04ca58"));
			ColumnPrefixFilter filter2 = new ColumnPrefixFilter(Bytes.toBytes("2f39fca9cacb4da084d72e23954e8cb9"));
			ColumnPrefixFilter filter3 = new ColumnPrefixFilter(Bytes.toBytes("66109775faad42428ca9b73102533328"));
			ColumnPrefixFilter filter4 = new ColumnPrefixFilter(Bytes.toBytes("db87c6b7fd054e6e959c520279d5804f"));
