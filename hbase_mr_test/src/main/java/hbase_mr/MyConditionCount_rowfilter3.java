...
public class MyConditionCount_rowfilter3 {
	...
	public static void main(String[] args){	
		...
		Job job;
		try {
			job = Job.getInstance(config, "MyConditionCount_rowfilter3");
			job.setJarByClass(MyConditionCount_rowfilter3.class);     // class that contains mapper
