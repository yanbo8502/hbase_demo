...
public class MyConditionCount21 {
	...
	public static void main(String[] args){	
		...
		Job job;
		try {
			job = Job.getInstance(config, "MyConditionCount21");
			job.setJarByClass(MyConditionCount21.class);     // class that contains mapper
			...
			SingleColumnValueFilter filter2 = new SingleColumnValueFilter(Bytes.toBytes("audiences"), Bytes.toBytes("2f39fca9cacb4da084d72e23954e8cb9"), CompareOp.EQUAL, comp);
