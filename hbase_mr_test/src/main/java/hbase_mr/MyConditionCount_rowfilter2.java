...
public class MyConditionCount_rowfilter2 {
	...
	public static void main(String[] args){	
		...
		Job job;
		try {
			job = Job.getInstance(config, "MyConditionCount_rowfilter2");
			job.setJarByClass(MyConditionCount_rowfilter2.class);     // class that contains mapper
